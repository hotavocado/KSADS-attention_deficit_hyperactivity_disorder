...
const protocolName = "KSADS_attention_deficit_hyperactivity_disorder"

//2. your protocol display name: this will show up in the app and be parsed as a string
const protocolDisplayName = "Attention Deficit Hyperactivity Disorder"

//2. create your raw github repo URL
const userName = 'hotavocado'
const repoName = 'KSADS-attention_deficit_hyperactivity_disorder'
const branchName = 'master'

let yourRepoURL = `https://raw.githubusercontent.com/${userName}/${repoName}/${branchName}`

//3. add a description to your protocol
let protocolDescription = "Attention Deficit Hyperactivity Disorder section for KSADS interview"
